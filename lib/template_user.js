module.exports = {
  ...
  userActivityTable:function(activitycc ,random_url, activitylist,team_num){
      ...
      <tr>
          <td style="border-bottom:2.5px solid black; width:30px; font-size: 25px; font-weight:bold;">ID</td>
          <td style="border-bottom:2.5px solid black; width:400px; font-size: 25px; font-weight:bold;">Activity</td>
          <td style="border-bottom:2.5px solid black; width:30px; font-size: 25px; font-weight:bold;">Score</td>
          <td style="border-bottom:2.5px solid black; width:100px; font-size: 25px; font-weight:bold;">Image</td>
          <td style="border-bottom:2.5px solid black; width:50px; font-size: 25px; font-weight:bold;">Delete</td>
      </tr>
        ...
        if(count < activitycc.length && activitylist[i].activity === activitycc[count].activity){
          tag += `
              <tr>
                  ...
                  <td style="border-bottom:2px solid lightgrey;">${activitycc[count].activity}</td>
                  <td style="border-bottom:2px solid lightgrey;">${activitycc[count].score}</td>
