    ...
    for(var i = 0; i< url.length; i++){
      ...
      <tr>
        ...
        <td>
            ...
            <script type="text/javascript">
                function shareKakaotalk() {
                    ...
                    Kakao.Link.sendDefault({
                        ...
                        , content : {
                            title:"Team CC 링크"
                            , description:"http://localhost:3000/user?id=${url[i].url}"   // 콘텐츠 상세설명
                            , imageUrl:"https://ifh.cc/g/CAOojM.png"
                            , link : {
                                mobileWebUrl:"http://localhost:3000/user?id=${url[i].url}"   // 모바일 카카오톡에서 사용하는 웹 링크 URL
                                , webUrl:"http://localhost:3000/user?id=${url[i].url}" // PC버전 카카오톡에서 사용하는 웹 링크 URL
                            }
                        }, buttons : [
                            { title:"팀CC 링크로 들어가기"    // 버튼 제목
                                , link : {
                                    mobileWebUrl:"http://localhost:3000/user?id=${url[i].url}"   // 모바일 카카오톡에서 사용하는 웹 링크 URL
                                , webUrl:"http://localhost:3000/user?id=${url[i].url}" // PC버전 카카오톡에서 사용하는 웹 링크 URL
                                }
            ...
            <img src="https://ifh.cc/g/BbQVhq.png" onClick="shareKakaotalk();" width="50" alt="Share" class="btnImg">
        </form>
        </td>
      </tr>
      `;
